...
<div class="news-letter-section bg-gray-100 pb-16">
    <div class="container">
        <div class="max-w-[600px] mx-auto">
            <div class="text-center">
                <a href="#" class="inline-block">
                    <img src="{{ Storage::url(option('site_logo')) }}" alt="brand logo" loading="lazy" width="145" height="65"/>
                </a>
                ...
                <form id="mc-form" class="relative text-center md:max-w-xl mx-auto mb-10">
                    ...
                    <button id="mc-submit" type="submit"
                            class="bg-dark transition-all hover:bg-orange hover:text-white px-10 sm:px-3 py-5 sm:py-1 rounded-l-full sm:rounded-l-none rounded-r-full text-white capitalize font-medium text-sm lg:text-md sm:absolute sm:top-0 sm:right-0 sm:h-full mt-3 sm:mt-0 leading-none w-full sm:w-auto">
                        Subscribe
                    </button>
                </form>
