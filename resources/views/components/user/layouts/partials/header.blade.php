                ...
                <nav class="main-menu">
                    <ul class="flex flex-wrap">
                        <li class="main-menu__item relative group">
                            <a class="block py-10 xl:pr-6 md:pr-5 capitalize font-normal text-md text-primary hover:text-primary transition-all"
                            ...
                            <ul class="submenu bg-white py-3 px-8 shadow transition-all absolute left-0 top-full opacity-0 group-hover:opacity-100 invisible group-hover:visible group-hover:-translate-y-3 transform z-10 min-w-max">
                                <li class="my-3"><a
                                        class="text-dark font-normal text-base capitalize transition-all hover:text-primary"
                        ...
                        <li class="main-menu__item group">
                            <a class="block py-10 xl:px-6 md:px-5 capitalize font-normal text-md text-primary hover:text-primary transition-all"
                               href="#">Shop</a>
                            <ul class="mega-menu flex flex-wrap bg-white py-5 px-8 shadow transition-all absolute left-0 top-full opacity-0 group-hover:opacity-100 invisible group-hover:visible group-hover:-translate-y-3 transform z-10">
                                <li class="flex-auto px-4">
                                    <a class="font-normal text-base capitalize text-dark pb-5 border-b block border-solid border-gray-600 mb-6 tracking-wide transition-all hover:text-primary"
                                       href="#">Shop Grid </a>
                                    <ul class="pb-2">
                                        <li class="my-3"><a
                                                class="font-normal text-base capitalize text-dark tracking-wide block hover:text-primary transition-all"
                        ...
                        <li class="main-menu__item relative group"><a
                                class="block py-10 xl:px-6 md:px-5 capitalize font-normal text-md text-primary hover:text-primary transition-all"
                                href="#">Blog</a>
            ...
            <div class="w-6/12 lg:w-3/12">
                <ul class="flex items-center justify-end">
                    <li class="ml-6 hidden lg:block">
                        <button class="search-toggle text-right text-primary text-md hover:text-primary transition-all"
                    ...
                    <li class="ml-6">
                        <a href="#offcanvas-cart"
                           class="text-primary text-md hover:text-primary transition-all relative offcanvas-toggle">
                            <span
                    ...
                    <li id="toggle-menu" class="ml-6 hidden lg:block relative">
                        <button class="text-primary text-md hover:text-primary transition-all toggle-menu"
                                aria-label="icon-settings">
                        ...
                        <div id="settings-card"
                            ...
                            <ul>
                                <li class="my-4"><a href="#"
                                                    class="text-base text-dark hover:text-primary transition-all font-light capitalize tracking-wide">USD
                                        - US Dollar</a></li>
                                <li class="my-4"><a href="#"
                                                    class="text-base text-dark hover:text-primary transition-all font-light capitalize tracking-wide">EUR
                                        - Euro</a></li>
                                <li class="my-4"><a href="#"
                                                    class="text-base text-dark hover:text-primary transition-all font-light capitalize tracking-wide">GBP
                                        - British Pound</a></li>
                            </ul>
                            <h4 class="text-md text-dark font-normal capitalize tracking-wide pb-5 border-b border-solid border-gray-600 mb-5">
                                Account</h4>
                            <ul>
                                ...
                                <li class="my-4">
                                    <a href="{{ route('account') }}"
                                                    class="text-base text-dark hover:text-primary transition-all font-light capitalize tracking-wide">
                                        {{ auth()->user()->name }}
                                    </a>
                                </li>
                                <li class="my-4">
                    ...
                    <li class="ml-6 lg:hidden">
                        <a href="#offcanvas-mobile-menu"
                           class="offcanvas-toggle text-primary text-md hover:text-primary transition-all"><i
                                class="icon-menu"></i></a>
                    </li>
                </ul>
            </div>
...
<div id="offcanvas-mobile-menu"
    ...
    <div class="px-8 py-12 h-5/6 overflow-y-hidden">
        ...
        <!-- close button start -->
        <button
            class="offcanvas-close group transition-all hover:text-primary text-dark w-10 h-10 flex items-center justify-center absolute top-2 right-0 text-base"
            ...
            <ul>
                <li class="relative block">
                    ...
                    <ul class="offcanvas-submenu static top-auto hidden w-full visible opacity-100">
                        <li>
                            <a class="text-sm py-2 px-4 text-dark font-light block font-roboto transition-all hover:text-primary"
                               href="index.html">Airpod</a></li>
                        <li>
                            <a class="text-sm py-2 px-4 text-dark font-light block font-roboto transition-all hover:text-primary"
                               href="index-2.html">Smartwatch</a></li>
                ...
                <li class="relative block">
                    ...
                    <ul class="offcanvas-submenu static top-auto hidden w-full visible opacity-100">
                        <li>
                            ...
                            <ul class="offcanvas-submenu static top-auto hidden w-full visible opacity-100">
                                <li>
                                    <a class="text-sm pt-3 px-10 pb-1 text-dark font-light block font-roboto transition-all hover:text-primary"
        ...
        <nav>
            <ul id="settings-menu">
                <li class="block mb-3">
                    <a class="flex flex-wrap justify-between mb-3 text-base text-dark hover:text-primary"
                    ...
                    <ul class="sub-category hidden py-5 px-6 shadow">
                        <li class="my-2 block"><a
                                class="font-light text-sm tracking-wide text-dark block hover:text-primary" href="#">EUR
                                €</a></li>
                        <li class="my-2 block"><a
                                class="font-light text-sm tracking-wide text-dark block hover:text-primary" href="#">USD
                                $</a></li>
                    </ul>
                </li>
                <li class="block mb-3">
                    ...
                    <ul class="sub-category hidden py-5 px-6 shadow">
                        <li class="my-2 block"><a
                                class="font-light text-sm tracking-wide text-dark block hover:text-primary" href="#">English</a>
                        </li>
                        <li class="my-2 block"><a
                                class="font-light text-sm tracking-wide text-dark block hover:text-primary" href="#">Français</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<div id="offcanvas-cart"
    ...
    <div class="p-8">
        <div class="flex flex-wrap justify-between items-center pb-6 mb-6 border-b border-solid border-gray-600">
            ...
            <button class="offcanvas-close hover:text-primary" aria-label="close icon"><i class="icon-close"></i>
            </button>
        </div>
        <ul class="h-96 overflow-y-auto">
            <li class="flex flex-wrap group mb-8">
                <div class="mr-5 relative">
                    ...
                    <button
                        class="absolute top-3 left-3 opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all hover:text-primary">
                        <i class="icon-close"></i></button>
                </div>
                <div class="flex-1">
                    <h4>
                        <a class="font-light text-sm md:text-base text-dark hover:text-primary transition-all tracking-wide"
